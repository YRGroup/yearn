 ...
 * @version 1.0
 */
  get_template_part('en/headers/kindergarten_header')
?>
<?php
...
<section class="page_content" >
  ...
  <section class="kinder_classes" id="kinder_classes">
    ...
    <div class="yearn_content double_swiper"> 
      <div class="classes_swiper_top">
        <div class="swiper-wrapper">
          <?php $courses = get_posts(array('post_type' => 'post','category' => '15','numberposts' => '0'));?>
          ...
          <article class="swiper-slide">
            ...
            <div class="class_desc">
              ...
              <a href="<?php  get_link_withcatgory($post,15); ?>" class="more">MORE</a>
            </div>
          </article>
  ...
  <section class="kinder_videos" id="kinder_videos">
    <h1 class="yearn_title">logistic service</h1>
    <h2 class="yearn_subtitle">幼儿园视频</h2>
    <div class="yearn_content">
  ...
  <section class="video_wrapper  animated fadeInDown">
    ...
    <video id="video"  preload="auto" controls="controls" autoplay=""  width="100%" src="http://yr-zhxy.oss-cn-beijing.aliyuncs.com/YRVideo/web_index.mp4"> 
    </video>
  </section>
  <?php 

        ...
        <section class="yearn_map">
          <div class="yearn_content container">
            ...
            <div class="item col-md-3 imgs">
              <img class="codeImg" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo/logo2.png" alt="易尔实验园区">
              <img style="width:150px;height:150px;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/yearn_codeImg.jpg" alt="易尔实验园区">
            </div>
          </div>
        </section>
        <footer class="yearn_footer">
          <p>Copyright ©2017 yearnedu.com Inc. All Rights Reserved. 郑州育人教育集团&nbsp;&nbsp;&nbsp; 备案/许可证编号：<a  href="http://www.miibeian.gov.cn" target="_blank">豫ICP备16026588号</a></p>
        </footer>
      <!-- </div>
    </div>
  </div> -->
